...
export interface paths {
    ...
    "/v1/workspaces/{workspaceId}/balance/policy/{policyId}": {
         ...
         */
        get: operations["getPtoBalancesForPolicy"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/workspaces/{workspaceId}/balance/user/{userId}": {
         ...
         */
        get: operations["getPtoBalancesForUser"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/workspaces/{workspaceId}/policies": {
         ...
         */
        get: operations["findPtoPoliciesForWorkspace"];
        put?: never;
        /**
         * Create time off policy
         * @deprecated
         ...
         */
        post: operations["createPtoPolicy"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspaceId}/policies/{id}": {
         ...
         */
        put: operations["updatePtoPolicy"];
        post?: never;
        /**
         * Delete policy
         * @deprecated
         ...
         */
        delete: operations["deletePtoPolicy"];
        options?: never;
        head?: never;
        /**
         * Change policy status
         ...
         */
        patch: operations["updatePtoPolicyStatus"];
        trace?: never;
    };
    "/v1/workspaces/{workspaceId}/policies/{policyId}/requests": {
         ...
         */
        post: operations["createPtoTimeOffRequest"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspaceId}/policies/{policyId}/requests/{requestId}": {
         ...
         */
        delete: operations["deletePtoTimeOffRequest"];
        options?: never;
        head?: never;
        /**
         * Change time off request status
         ...
         */
        patch: operations["changePtoTimeOffRequestStatus"];
        trace?: never;
    };
    "/v1/workspaces/{workspaceId}/policies/{policyId}/users/{userId}/requests": {
         ...
         */
        post: operations["createPtoTimeOffRequestForOther"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspaceId}/requests": {
         ...
         */
        post: operations["getPtoTimeOffRequests"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CreatePolicyRequestV1: {
            ...
            approve: components["schemas"]["ApproveDto"];
            /**
        ...
        Feature: {
            ...
            /** @enum {string} */
            ADMIN_PANEL?: "ADD_TIME_FOR_OTHERS" | "ADMIN_PANEL" | "ALERTS" | "APPROVAL" | "AUDIT_LOG" | "AUTOMATIC_LOCK" | "BRANDED_REPORTS" | "BULK_EDIT" | "CUSTOM_FIELDS" | "CUSTOM_REPORTING" | "CUSTOM_SUBDOMAIN" | "DECIMAL_FORMAT" | "DISABLE_MANUAL_MODE" | "EDIT_MEMBER_PROFILE" | "EXCLUDE_NON_BILLABLE_FROM_ESTIMATE" | "EXPENSES" | "FILE_IMPORT" | "HIDE_PAGES" | "HISTORIC_RATES" | "INVOICING" | "INVOICE_EMAILS" | "INVOICE_REMINDERS" | "LABOR_COST" | "LOCATIONS" | "MANAGER_ROLE" | "MULTI_FACTOR_AUTHENTICATION" | "PROJECT_BUDGET" | "PROJECT_TEMPLATES" | "QUICKBOOKS_INTEGRATION" | "RECURRING_ESTIMATES" | "RECURRING_INVOICES" | "REQUIRED_FIELDS" | "SCHEDULED_REPORTS" | "SCHEDULING" | "SCREENSHOTS" | "SSO" | "SUMMARY_ESTIMATE" | "TARGETS_AND_REMINDERS" | "TASK_RATES" | "TIME_OFF" | "UNLIMITED_REPORTS" | "USER_CUSTOM_FIELDS" | "WHO_CAN_CHANGE_TIMEENTRY_BILLABILITY" | "BREAKS" | "KIOSK_SESSION_DURATION" | "KIOSK_PIN_REQUIRED" | "WHO_CAN_SEE_ALL_TIME_ENTRIES" | "WHO_CAN_SEE_PROJECT_STATUS" | "WHO_CAN_SEE_PUBLIC_PROJECTS_ENTRIES" | "WHO_CAN_SEE_TEAMS_DASHBOARD" | "WORKSPACE_LOCK_TIMEENTRIES" | "WORKSPACE_TIME_AUDIT" | "WORKSPACE_TIME_ROUNDING" | "KIOSK" | "FORECASTING" | "TIME_TRACKING" | "ATTENDANCE_REPORT" | "WORKSPACE_TRANSFER" | "FAVORITE _ENTRIES" | "SPLIT_TIME_ENTRY" | "CLIENT_CURRENCY" | "SCHEDULING_FORECASTING";
            /** @enum {string} */
        ...
        PtoCreatePolicyRequestV1: {
             ...
             */
            archived?: boolean;
            automaticAccrual?: components["schemas"]["PtoAutomaticAccrualRequest"];
            automaticTimeEntryCreation?: components["schemas"]["AutomaticTimeEntryCreationRequest"];
            /**
             * @description Provide color in format ^#(?:[0-9a-fA-F]{6}){1}$. Explanation: A valid color code should start with '#' and consist of six hexadecimal characters, representing a color in hexadecimal format. Color value is in standard RGB hexadecimal format.
             * @example #8BC34A
        ...
        PtoCreateTimeOffRequestV1Request: {
             ...
             */
            note?: string;
            timeOffPeriod: components["schemas"]["PtoTimeOffRequestPeriodV1Request"];
        };
        ...
        PtoTimeOffRequestPeriodV1Request: {
             ...
             */
            isHalfDay?: boolean;
            period: components["schemas"]["PtoPeriodV1Request"];
        };
        /** @description Represents the status the time off request. */
        ...
        TimeOffRequestDtoV1: {
             ...
             */
            policyId?: string;
            status?: components["schemas"]["PtoTimeOffRequestStatus"];
        ...
        TimeOffRequestPeriod: {
            halfDay?: boolean;
            halfDayHours?: components["schemas"]["PtoPeriod"];
            /** @description Indicates half day period of time off. */
            halfDayPeriod?: string;
            period?: components["schemas"]["PtoPeriod"];
        };
        ...
        SharedReportDtoV1: {
             ...
             * @enum {string}
             */
            type?: "DETAILED" | "WEEKLY" | "SUMMARY" | "SCHEDULED" | "EXPENSE_DETAILED" | "EXPENSE_RECEIPT" | "PTO_REQUESTS" | "PTO_BALANCE" | "ATTENDANCE" | "INVOICE_EXPENSE" | "PROJECT" | "TEAM_FULL" | "TEAM_LIMITED" | "TEAM_GROUPS" | "INVOICES";
...
export interface operations {
    ...
    findPtoPoliciesForWorkspace: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PtoPolicyDtoV1"][];
                };
            };
        };
    };
    createPtoPolicy: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PtoCreatePolicyRequestV1"];
            };
        };
        responses: {
            /** @description Created */
    ...
    updatePtoPolicy: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PtoUpdatePolicyRequestV1"];
            };
        };
        responses: {
            /** @description OK */
    ...
    createPtoTimeOffRequest: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PtoCreateTimeOffRequestV1Request"];
            };
        };
        responses: {
            /** @description OK */
    ...
    createPtoTimeOffRequestForOther: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    getPtoTimeOffRequests: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PtoGetTimeOffRequestsV1Request"];
            };
        };
        responses: {
            /** @description OK */
